...
from typing import (IO, TYPE_CHECKING, Any, Callable, Dict, Iterable, List,
                    Literal, Optional, Sequence, Tuple, TypeVar, Union, BinaryIO)
...
def lazy_load_ggml_file(fp: Union[io.BufferedReader, BinaryIO], path: Path) -> ModelPlus:
...
def main(args_in: Optional[List[str]] = None) -> None:
    ...
    parser.add_argument("--outtype", choices=["f32", "f16", "q4_1", "q4_0"],
